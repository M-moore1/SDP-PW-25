...
#
# Script generated by Vivado on Tue Dec 09 12:11:24 -0500 2025
...
#
# Usage        : ZCU102.sh
#                ZCU102.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ZCU102.sh [-reset_run]
#                ZCU102.sh [-reset_log]
#                ZCU102.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx/2025.1.1/Vivado/data"
...
# script info
echo -e "ZCU102.sh - Script generated by export_simulation (Vivado v2025.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ZCU102.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ZCU102 xil_defaultlib.ZCU102 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ZCU102 -key {Behavioral:sim_1:Functional:ZCU102} -tclbatch cmd.tcl -protoinst "protoinst_files/ZCU102.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/2025.1.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ZCU102.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ZCU102.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ZCU102.sh [-help]\n\
Usage: ZCU102.sh [-step]\n\
Usage: ZCU102.sh [-lib_map_path]\n\
Usage: ZCU102.sh [-reset_run]\n\
Usage: ZCU102.sh [-reset_log]\n\
Usage: ZCU102.sh [-keep_index]\n\
Usage: ZCU102.sh [-noclean_files]\n\n\
