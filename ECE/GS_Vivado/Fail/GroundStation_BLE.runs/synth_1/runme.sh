...
HD_PWD='C:/Users/ist21005/Documents/Board_Practice/pmod_ip/pmod_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZCU102_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZCU102_wrapper.tcl
