...
#
# Script generated by Vivado on Fri Feb 27 17:17:33 -0500 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Ground_Station.sh
...
#
# Usage        : Ground_Station.sh
#                Ground_Station.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Ground_Station.sh [-reset_run]
#                Ground_Station.sh [-reset_log]
#                Ground_Station.sh [-help]
#
...
# script info
echo -e "Ground_Station.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Ground_Station.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Ground_Station xil_defaultlib.Ground_Station xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Ground_Station -key {Behavioral:sim_1:Functional:Ground_Station} -tclbatch cmd.tcl -protoinst "protoinst_files/Ground_Station.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Ground_Station.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Ground_Station.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Ground_Station.sh [-help]\n\
Usage: Ground_Station.sh [-step]\n\
Usage: Ground_Station.sh [-lib_map_path]\n\
Usage: Ground_Station.sh [-reset_run]\n\
Usage: Ground_Station.sh [-reset_log]\n\
Usage: Ground_Station.sh [-keep_index]\n\
Usage: Ground_Station.sh [-noclean_files]\n\n\
