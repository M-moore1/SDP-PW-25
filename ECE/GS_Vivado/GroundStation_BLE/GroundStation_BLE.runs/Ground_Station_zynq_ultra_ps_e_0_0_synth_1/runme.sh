...
HD_PWD='C:/Users/ist21005/Documents/GS_Vivado/GroundStation_BLE/GroundStation_BLE.runs/Ground_Station_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ground_Station_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ground_Station_zynq_ultra_ps_e_0_0.tcl
