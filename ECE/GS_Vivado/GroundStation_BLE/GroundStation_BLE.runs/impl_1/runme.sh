...
HD_PWD='C:/Users/ist21005/Documents/GS_Vivado/GroundStation_BLE/GroundStation_BLE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ground_Station_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ground_Station_wrapper.tcl -notrace
