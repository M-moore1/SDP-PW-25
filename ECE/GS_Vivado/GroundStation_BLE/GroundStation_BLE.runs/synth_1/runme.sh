...
HD_PWD='C:/Users/ist21005/Documents/GS_Vivado/GroundStation_BLE/GroundStation_BLE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ground_Station_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ground_Station_wrapper.tcl
