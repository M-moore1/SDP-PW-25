...
module design_1
   (BLE_CTS,
    ...
    BLE_TX);
  output BLE_CTS;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BLE_GPIO DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BLE_GPIO, LAYERED_METADATA undef" *) input [0:0]BLE_GPIO;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BLE_MODE DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BLE_MODE, LAYERED_METADATA undef" *) input [0:0]BLE_MODE;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BLE_RTS DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BLE_RTS, LAYERED_METADATA undef" *) input BLE_RTS;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BLE_RX DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BLE_RX, LAYERED_METADATA undef" *) output BLE_RX;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.BLE_STATUS DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.BLE_STATUS, LAYERED_METADATA undef" *) input [0:0]BLE_STATUS;
  ...
  design_1_axi_gpio_0_0 BLE_GPIO_RnM
       (.gpio2_io_i(ilconcat_0_dout),
        .gpio_io_o(BLE_RST),
        .ip2intc_irpt(BLE_GPIO_ip2intc_irpt),
  ...
  assign ilconcat_0_dout = {BLE_STATUS, BLE_MODE, BLE_GPIO};
  ...
  design_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.emio_uart1_ctsn(BLE_RTS),
        ...
        .pl_ps_irq0(BLE_GPIO_ip2intc_irpt),
