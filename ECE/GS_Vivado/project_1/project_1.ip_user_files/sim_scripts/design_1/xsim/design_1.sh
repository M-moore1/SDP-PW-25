...
#
# Script generated by Vivado on Sat Apr 04 22:03:52 -0400 2026
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ad43.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
