...
set psu_mio_init_data {
    ...
    #  Ext Tamper)
		# PSU_IOU_SLCR_MIO_PIN_20_L2_SEL                                                  3
    ...
    # 1_txd- (UART transmitter serial output) 7= Not Used
		...
		#(OFFSET, MASK, VALUE)      (0XFF180050, 0x000000FEU ,0x00000018U)  */
    mask_write 0XFF180050 0x000000FE 0x00000018
    ...
    mask_write 0XFF180134 0x000000FE 0x000000C0
		...
		#(OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x52140000U)  */
    mask_write 0XFF180204 0xFFFFFFFF 0x52140000
