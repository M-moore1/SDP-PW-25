...
HD_PWD='C:/Users/ist21005/Documents/GS_Vivado/AES_Block/AES_Block.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_aes_gcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_aes_gcm.tcl
